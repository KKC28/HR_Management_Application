...
public class FinalHiring extends AppCompatActivity {
    ...
    private void populateListView() {
        ...
        while (cursor.moveToNext()) {
            if (cursor.getString(3).equals("Hired")) {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                while (cursor.moveToNext()) {
                    if (cursor.getString(0).equals(mlistView.getItemAtPosition(i).toString())) {
                        Intent intent = new Intent(getApplicationContext(), HiredCandiadtes.class);
