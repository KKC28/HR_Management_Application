...
public class Wrriten_Marks extends AppCompatActivity {
    ...
    private void populateListView() {
        ...
        while (cursor.moveToNext()) {
            if (cursor.getString(3).equals("Wriiten Accepted")) {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                while (cursor.moveToNext()) {
                    if (cursor.getString(0).equals(mlistView.getItemAtPosition(i).toString())) {
                        Intent intent = new Intent(getApplicationContext(), Update_Marks.class);
